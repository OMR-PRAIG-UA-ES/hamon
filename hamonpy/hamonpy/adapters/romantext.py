...
Roman numeral becomes a degree-system label. `mX = mY` repeat lines are skipped.
...
from hamonpy.ast import (
    HamonSequence, HarmonyGroup, HarmonyLabel, RenderingHints, TextSemantic, TonalRegion,
)
...
def romantext_to_hamon(text: str) -> HamonSequence:
    ...
    for raw in text.splitlines():
        ...
        for tok in s.split()[1:]:          # skip the measure-id token
